        ...
        <div class="container">
          <div class="row">
            ...
            <div class="calculate_shoping_area">
              <h3 class="cart_single_title">Insert Product<span></i></span></h3>
              <div class="calculate_shop_inner">
                <form class="calculate_shoping_form row" action="\insertProduk" method="post" id="contactForm">
                    ...
                    <?php foreach (($newId?:[]) as $new): ?>
                      <div class="form-group col-lg-12">
                        <input type="text" class="form-control" id="state" name="idproduk" placeholder="" value="<?= $new ?>" readonly="true" >
                      </div>
                    <?php endforeach; ?>
                    <div class="form-group col-lg-12">
                      <input type="text" class="form-control" id="zip" name="deskripsi" placeholder="Deskripsi" required="">
                    </div>
                    <div class="form-group col-lg-12">
                      <input type="number" class="form-control" id="state" name="harga" placeholder="Harga" required="">
                    </div>
                    <div class="form-group col-lg-12">
                      <input type="text" class="form-control" id="zip" name="urlGambar" placeholder="URL Gambar" required="">
                    </div>
                    <div class="form-group col-lg-12">
                      <input type="text" class="form-control" id="state" name="nama" placeholder="Nama" required="">
                    </div>
                    <div class="form-group col-lg-12">
                      <input type="number" class="form-control" min="1" max="5" id="zip" name="kategori" placeholder="Kategori" required="">
                    </div>

                    <div class="form-group col-lg-12">
                      <button type="submit" value="submit" class="btn submit_btn form-control">Insert</button>
                    </div>
                  </form>
                </div>
              </div>
