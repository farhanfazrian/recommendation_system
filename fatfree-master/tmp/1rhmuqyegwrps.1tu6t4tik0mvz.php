          ...
          <a class="navbar-brand" href="#">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <li class="nav-item dropdown submenu">
                ...
                <ul class="dropdown-menu">
                  <li class="nav-item"><a href="/category/1">Gitar Listrik</a></li>
                  <li class="nav-item"> <a href="/category/2">Gitar Akustik</a></li>
                  <li class="nav-item"> <a href="/category/6">Efek</a></li>
                  <li class="nav-item"><a href="/category/3">Pick</a></li>
                  <li class="nav-item"> <a href="/category/5">Strap</a></li>
                  <li class="nav-item">  <a href="/category/4">Senar</a></li>
                </ul>
              </li>
