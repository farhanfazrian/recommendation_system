				...
				<div class="row">
					...
					<div class="col-lg-7">
						...
						<h4>
							...
							<div class="quantity">
								<form method="POST" action="/hitung_beli" style="padding-top: 10px ; margin-left: -7px;">
									<div class="custom">
									...
									<button class="add_cart_btn"  onclick="popUpBeli()" type="submit" id="addtoChart" name="Epiphone" value="<?= $prd['idproduk'] ?>" >buy</button>
								</form>
								<!--<a class="add_cart_btn" href="/hitung_beli">add to cart</a>-->
							</div>
			...
			<div class="container">
				<nav class="tab_menu">
					<div class="nav nav-tabs" id="nav-tab" role="tablist">
						...
						<?php if ($nilaiPembelian>='0'): ?>
							<a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false" style="display: none">Add Review</a>
						<?php endif; ?>
						<?php if ($nilaiPembelian<'0'): ?>
				...
				<div class="tab-content" id="nav-tabContent">
					...
					<div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
						...
						<p><?= $prd['nama'] ?> </p>
						<br>
						<!--method untuk dapetin isi review -->	
						<form method="POST" class="inputRating" action="/hitung_rating">
							<div class="slidecontainer">
								<input type="text" class="inputIdProduk" name="Epiphone" value="<?= $prd['idproduk'] ?>" readonly style="display: none">
								<h5>Your Rating</h5>
								<br>
								<input type="range" min="0" max="5" class="slider" id=<?= $prd['idproduk'] ?> name="inputRating" value="0" >
								<h6>Rating: <span id="nilai"></span></h6>
								<br>
							</div>
							<label for="rvw"><b><h5>Review</h5></b></label>
							<br>
							<!--<input  class="inputRating" type="text" placeholder="Enter Review" name="review">-->

							<textarea  class="inputRating" name="review" rows="3" cols="50">Enter Review...</textarea>
							<br>
							<button class="add_cart_btn"" onclick="popUpReview()" type="Submit" class="inputRating">Submit</button>
						</form>
					</div>
