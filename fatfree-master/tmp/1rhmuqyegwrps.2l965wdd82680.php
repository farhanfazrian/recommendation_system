	...
	<section class="shopping_cart_area p_100">
		<div class="container">
			<div class="row">
				<div class="col-lg-8">
					...
					<?php if ($idProdukUpdate>'0'): ?>
						<div class="cart_product_list">
							<h3 class="cart_single_title">Detail Produk Delete</h3>
							<div class="table-responsive-md">
								<table class="table">
									<thead>
										<tr>
            ...
            <div class="calculate_shoping_area">
            	<h3 class="cart_single_title">Delete Product <span></span></h3>
            	<div class="calculate_shop_inner">
            		<form class="calculate_shoping_form row" action="/deleteProduk" method="post" id="contactForm" novalidate="novalidate">
            			...
            			<div class="form-group col-lg-12">
            				<select name="produkUpdate" class="selectpicker" onchange="location = this.value;" >
            					...
            					<?php foreach (($sp?:[]) as $produk): ?>
            						<option value="/delete/<?= $produk['idproduk'] ?>"><?= $produk['idproduk'] ?></option>
            					<?php endforeach; ?>	 
            				</select>			
            			</div>
            			<?php if ($idProdukUpdate>'0'): ?>   
            				<div class="form-group col-lg-12">
            					<input type="number" class="form-control" min="1" max="5" id="zip" name="idproduk" value="<?= $idProdukUpdate ?>"placeholder="Kategori"   readonly="">
            				</div>         				
            				<div class="form-group col-lg-12">
            					<button type="submit" value="submit" class="btn submit_btn form-control">Delete</button>
            				</div>
            			<?php endif; ?>
            		</form>
            	</div>
