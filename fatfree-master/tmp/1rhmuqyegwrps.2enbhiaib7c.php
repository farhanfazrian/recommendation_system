  ...
  <ul class="pagination">
   <?php foreach (($countProduk?:[]) as $i): ?>
    <!-- pencarian aja -->
        ...
        <li  class="page-item"><a style="border: 0px;" class="page-link" href="/category/<?= $idcategory ?>/<?= $i ?>?pencarian=<?= $GET['pencarian'] ?>&batasMax=<?= $GET['batasMax'] ?>&batasMin=<?= $GET['batasMin'] ?>"> <?= $i ?> </a> </li>
...
<section class="related_product_area">
   <?php echo $this->render('RekomendasiItemBased.htm',NULL,get_defined_vars(),0); ?>
</section>
...
<!-- ======= Bagian div perhitungan ======= -->
<div class ="perhitungan d-none">
    <table border="1">
      <thead>
        <tr>
          <th>idpengguna</th>
  ...
  <tbody>
    <?php foreach (($tableNilaiKeseluruhan?:[]) as $hasilTable): ?>
      <tr>
        <td><?= $hasilTable['idpengguna'] ?></td>
        <td><?= $hasilTable['idproduk'] ?></td>
        <td><?= $hasilTable['score'] ?></td>
    </tr>
<?php endforeach; ?>
</tbody>
...
<h1> User based </h1>
<br>
<?php foreach (($nilai?:[]) as $hasil1): ?>
  <p><?= $hasil1 ?></p>
<?php endforeach; ?>

<?php foreach (($produkBerbeda?:[]) as $hasil): ?>
  <p><?= $hasil ?></p>
<?php endforeach; ?>
<?php foreach (($rincianRekomendasi?:[]) as $hasil): ?>
  <p><?= $hasil ?></p>
<?php endforeach; ?>
<?php foreach (($tampilanRekomendasi?:[]) as $hasil): ?>
  <p><?= $hasil ?></p>
<?php endforeach; ?>
<br>
<h1>Item Based</h1>
<br>
<?php foreach (($nilaiProduk?:[]) as $hasil1): ?>
  <p><?= $hasil1 ?></p>
<?php endforeach; ?>
<?php foreach (($penggunaBerbeda?:[]) as $hasil): ?>
  <p><?= $hasil ?></p>
<?php endforeach; ?>
<?php foreach (($rincianRekomendasiItem?:[]) as $hasil): ?>
  <p><?= $hasil ?></p>
<?php endforeach; ?>
<?php foreach (($tampilanRekomendasiItem?:[]) as $hasil): ?>
  <p><?= $hasil ?></p>
<?php endforeach; ?>
</div>
<!-- ======= Akhir div perhitungan =======-->

<!--====== Script bagian ngilangin page =====-->
<script>
  document.querySelectorAll("div:not(.perhitungan),section").forEach(function(item){})
  var state = 1;
  window.addEventListener("keyup",function(e){
    console.log(e.keyCode);
    if(e.keyCode===192){
      if(state===1){
        document.querySelectorAll("div:not(.perhitungan),section").forEach(function(item){item.classList.add("d-none")});
        document.querySelector(".perhitungan").classList.remove("d-none");
        state=0;
    }
    else{
        document.querySelectorAll("div:not(.perhitungan),section").forEach(function(item){item.classList.remove("d-none")});
        document.querySelector(".perhitungan").classList.add("d-none");
        state=1;
    }
}
})
